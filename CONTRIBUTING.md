...
| `docs/collaboration/2026-09-26-开发规范与AI协作.md` | **两个人 + 各自 AI 怎么一起写代码**（分支/提交/代码/测试/门禁/AI 边界/验收） |
| `docs/collaboration/_AI_PROMPT_CARDS.md` | **可直接复制给 AI 的提示词卡片**（开工前/实现中/交活前/卡点） |
